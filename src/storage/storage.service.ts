...
export type UploadPrefix = 'guest-photos' | 'tenant-logos' | 'tenant-videos' | 'tenant-display';
...
export class StorageService implements OnModuleInit {
  ...
  async saveImage(buffer: Buffer, mime: string, prefix: 'guest-photos' | 'tenant-logos' | 'tenant-display') {
  ...
  async deleteByUrl(url: string | null | undefined): Promise<void> {
    ...
    const prefix = (['guest-photos', 'tenant-logos', 'tenant-videos', 'tenant-display'] as const).find((p) =>
