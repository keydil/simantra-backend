...
export type UploadPrefix = 'guest-photos' | 'tenant-logos' | 'tenant-videos' | 'tenant-display' | 'sponsor-logos';
...
export class StorageService implements OnModuleInit {
  ...
  async saveImage(buffer: Buffer, mime: string, prefix: 'guest-photos' | 'tenant-logos' | 'tenant-display' | 'sponsor-logos') {
  ...
  async deleteByUrl(url: string | null | undefined): Promise<void> {
    ...
    const prefix = (
      ['guest-photos', 'tenant-logos', 'tenant-videos', 'tenant-display', 'sponsor-logos'] as const
